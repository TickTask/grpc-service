...
var file_task_task_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x01, 0x0a, 0x11,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x12, 0x37, 0x0a, 0x09, 0x63,
	...
	0x74, 0x65, 0x41, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	...
	0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x49, 0x64, 0x22, 0x2d, 0x0a, 0x12, 0x43, 0x72,
...
var file_task_task_proto_depIdxs = []int32{
	6, // 0: task.CreateTaskRequest.create_at:type_name -> google.protobuf.Timestamp
	6, // 1: task.GetTaskResponse.create_at:type_name -> google.protobuf.Timestamp
	7, // 2: task.GetTaskResponse.user:type_name -> user.UserData
	8, // 3: task.GetTaskResponse.status:type_name -> status.StatusData
	3, // 4: task.GetTasksResponse.tasks:type_name -> task.GetTaskResponse
	0, // 5: task.Task.CreateTask:input_type -> task.CreateTaskRequest
	2, // 6: task.Task.GetTask:input_type -> task.GetTaskRequest
	4, // 7: task.Task.DeleteTask:input_type -> task.DeleteTaskRequest
	9, // 8: task.Task.GetTasks:input_type -> google.protobuf.Empty
	1, // 9: task.Task.CreateTask:output_type -> task.CreateTaskResponse
	3, // 10: task.Task.GetTask:output_type -> task.GetTaskResponse
	9, // 11: task.Task.DeleteTask:output_type -> google.protobuf.Empty
	5, // 12: task.Task.GetTasks:output_type -> task.GetTasksResponse
